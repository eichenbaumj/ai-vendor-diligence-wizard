...
**Methodology version 1.7** · Effective September 1, 2026 · Licensed [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)
...
- Every report records the **methodology version** that produced it (this document is version 1.7) and the **sector pack release** it drew questions from.
