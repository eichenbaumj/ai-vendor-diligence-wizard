...
- named_customers: government agencies, cities, counties, or states the pitch claims as customers, pilots, or users.
- claims: every checkable assertion, each with a verbatim quote (trim to the shortest span that carries the claim). Type each one:
